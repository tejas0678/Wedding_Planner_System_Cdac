...
public class AuthServiceImpl implements AuthService {
    ...
    public ApiResponse<String> registerPlanner(RegisterPlannerRequest request) {
        ...
        notificationService.createNotification(
                ...
                "Your planner registration was submitted successfully and is awaiting admin approval.",
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        if (Boolean.FALSE.equals(user.getEnabled())) {
            throw new AccountDisabledException("Your account has been deactivated by the administrator. Please contact support.");
        }
